    ...
    Future<void> deleteSupervisor(String supervisorId, String email, String password) async {
      try {
    ...
    Future<void> updateSupervisor(String uid, String name, String department) async {
      try {
